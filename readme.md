...
- **The text backs the numbers.** Detractors mention management 2.5x more than
...
An interactive Streamlit dashboard with two views: an Executive View for the
CEO/CHRO, and a Risk & Voice View for operational use.

**Executive View**
![Executive View](assets/dashboard-preview1.png)

**Risk & Voice View**
![Risk and Voice View](assets/dashboard-preview2.png)
...
| `Glassdoor_CEO_Deck.pdf` | CEO/CHRO presentation deck (14 slides) |
| `Glassdoor_Cheatsheet.pdf` | One-page quick reference of every key number |
...
*Note: the raw review dataset is not included here (it is large and publicly
available on Kaggle). The notebook documents the full cleaning pipeline.*
